        ...
        <div id="container">
            ...
            <section id="services" class="services">
                <div class="row">
                    ...
                    <form id="contactform" role="form" method="post" action="${pageContext.request.contextPath}/updateUserPasswordServlet">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control"  placeholder="请再次输入新的密码" name="verifypassword">
                            </div>
