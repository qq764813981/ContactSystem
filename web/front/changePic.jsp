                ...
                <div class="row">
                    <div class="col-md-12 mg-bt-80">
                        <div class="header-content">
                            ...
                            <br><br><br>
                            <h3>上传新的头像,必须在电脑端或pad端操作！</h3>
                        </div>
                    </div>

                    <form id="contactform1" role="form" method="post" action="${pageContext.request.contextPath}/updateContactPicServlet" enctype="multipart/form-data">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                 <label>请选择一张图片,<font color="#dc143c"> 小于0.5M </font></label>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <button type="submit" class="btn">确定上传</button>
